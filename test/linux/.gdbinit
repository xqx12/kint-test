#   My customed gdbinit script, byxqx 20130619
#   copy STL GDB evaluators/views/utilities - 1.03   
#                          Thanks Dan Marinescu (H-PhD).

#   add print two flags, s-flag and o-flag
...
#   set monitor child process always
set follow-fork-mode child

#   set show next disassemble insn
